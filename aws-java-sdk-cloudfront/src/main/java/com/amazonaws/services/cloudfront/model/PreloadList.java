...
public class PreloadList implements Serializable, Cloneable {
     ...
     */
    private com.amazonaws.internal.ListWithAutoConstructFlag<PreloadSummary> items;
    ...
    public java.util.List<PreloadSummary> getItems() {
        if (items == null) {
            items = new com.amazonaws.internal.ListWithAutoConstructFlag<PreloadSummary>();
    ...
    public void setItems(java.util.Collection<PreloadSummary> items) {
        ...
        com.amazonaws.internal.ListWithAutoConstructFlag<PreloadSummary> itemsCopy = new com.amazonaws.internal.ListWithAutoConstructFlag<PreloadSummary>(items.size());
