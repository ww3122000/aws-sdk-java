 ...
 * </p>
 */
public class ListLogSettingResult implements Serializable, Cloneable {
     ...
     *         together.
     */
    public ListLogSettingResult withLocation(String location) {
        this.location = location;
        return this;
    }
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ListLogSettingResult other = (ListLogSettingResult) obj;
		if (location == null) {
	...
	@Override
    public ListLogSettingResult clone() {
        try {
            return (ListLogSettingResult) super.clone();
