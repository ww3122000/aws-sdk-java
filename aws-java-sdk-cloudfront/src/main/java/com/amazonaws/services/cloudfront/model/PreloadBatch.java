 ...
 * </p>
 */
public class PreloadBatch implements Serializable, Cloneable {
     ...
     */
    public PreloadBatch(Paths paths, String callerReference) {
        setPaths(paths);
     ...
     * CloudFront returns an InvalidationBatchAlreadyExists error.
     */
    public PreloadBatch(String callerReference) {
        setCallerReference(callerReference);
    }
     ...
     *         together.
     */
    public PreloadBatch withPaths(Paths paths) {
        this.paths = paths;
        return this;
    }
     ...
     *         together.
     */
    public PreloadBatch withCallerReference(String callerReference) {
        this.callerReference = callerReference;
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof PreloadBatch == false) return false;
        PreloadBatch other = (PreloadBatch)obj;
    ...
    @Override
    public PreloadBatch clone() {
        try {
            return (PreloadBatch) super.clone();
