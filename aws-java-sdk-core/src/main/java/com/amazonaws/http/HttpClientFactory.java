...
public class HttpClientFactory {
    ...
    public HttpClient createHttpClient(ClientConfiguration config) {
		...
		Builder requestConfigBuilder = RequestConfig.custom().setConnectTimeout(config.getConnectionTimeout())
		...
		CloseableHttpClient httpClient = HttpClients.custom().setConnectionManagerShared(true).setConnectionManager(cm)
